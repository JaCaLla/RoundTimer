...
extension Font {
    static let timerAndRoundLargeFont =  Font.system(size: 60, weight: .black)
    static let timerAndRoundMediumFont =  Font.system(size: 55, weight: .black)
    static let timerAndRoundSmallFont =  Font.system(size: 50, weight: .black)
